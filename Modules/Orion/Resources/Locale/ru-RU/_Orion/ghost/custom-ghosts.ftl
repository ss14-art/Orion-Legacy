...
custom-ghost-personal-placeholder-desc = Кастомный призрак, которым вы пользовались ранее, был сочтён чрезмерно большим или вырвиглазным, и был удалён.
        Вы всё ещё можете получить нового кастомного призрака - для этого обратитесь к кодербасу, либо сами откройте PR в репозитории проекта.
