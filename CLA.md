...
These rights are granted for the entire duration of the Contributor’s copyright and other applicable rights to the Contribution.
...
* which licenses are applied to Contributions
* whether a Contribution is relicensed
* whether dual or multiple licensing is used
* whether a licensing exception is granted
* whether proprietary or commercial licensing is permitted
...
The Organization Leader may distribute or relicense any Contribution covered by this Agreement under any license or licensing arrangement, including:
...
* the license specified in the Contribution’s file header
* the license specified in repository metadata
* the default license of the repository
* the license selected when the Contribution was submitted
...
Unless the Organization Leader explicitly approves another license, original source code created for Orion Station is distributed under:

`AGPL-3.0-or-later`

Only the Organization Leader may approve:

* another license
* an additional license
* a licensing exception
* dual or multiple licensing
* relicensing of a Contribution
* proprietary or commercial licensing

Documentation, graphics, audio, textures, and other non-code assets are distributed under the licenses specified in their file headers, metadata files, or other accompanying license declarations.

The Organization Leader may change or supplement the license of any Contribution covered by this Agreement.

## Ported and third-party content

This Agreement covers only rights owned or legally controlled by the Contributor.

The Contributor must not submit third-party material unless they have the legal right to do so.
...
* the Contribution is their original work or they have sufficient legal authority to submit it
* granting the rights described in this Agreement does not violate another agreement
* the Contribution does not knowingly violate third-party copyright, patent, trademark, or other intellectual property rights
* all required third-party notices and license declarations have been preserved
...
The Contributor accepts this Agreement by performing at least one of the following actions:
...
By performing one of these actions, the Contributor confirms that they have read, understood, and accepted this Agreement.
