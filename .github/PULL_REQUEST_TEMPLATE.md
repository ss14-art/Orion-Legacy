...
<!-- Согласие с CLA означает: ss14-art получает право использовать, модифицировать и распространять внесённые изменения в рамках условий лицензии -->
<!-- ⚠️ Отказ от лицензионного соглашения может повлечь за собой закрытие вашего PR ⚠️ -->

- [x] Я согласен с лицензионным соглашением Contributor License Agreement, для ss14-art.
